...
class WBTree:
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # Bassic tree search method by value. Calls the recursive method.
    def findnode2 (self, value):

        return self._findnode2(value, self.top)

    # ------------------------------------------------------------------------------------------------------------------
    # Recursive tree search method by value. When found adds 1 to the weight of the node.
    def _findnode2(self, value, node):
        ...
        if node.value == value:
            ...
            return self._findnode2(value, node.left)
        else:
            return self._findnode2(value, node.right)
